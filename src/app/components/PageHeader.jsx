...
export default function PageHeader({ eyebrow, title, intro }) {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -bottom-40 -left-40 h-[24rem] w-[24rem] rounded-full bg-[#003F73]/30 blur-[100px] sm:h-[32rem] sm:w-[32rem]" aria-hidden="true"/>
      ...
      <div className="container-x relative z-10">
        <div className="max-w-6xl">
          ...
          <SplitLines as="h1" className="max-w-5xl font-display text-[clamp(2.75rem,9vw,5rem)] font-medium leading-[0.94] tracking-[-0.045em] text-white sm:text-5xl md:text-6xl">
            {title}
          </SplitLines>
          {intro && (
            <Reveal delay={0.15}>
              <p className="mt-7 max-w-2xl text-[15px] leading-7 text-white/72 text-pretty sm:mt-9 sm:text-lg sm:leading-8 lg:mt-10 lg:text-xl lg:leading-9">
                {intro}
              </p>
            </Reveal>
          )}
          <Reveal delay={0.3}>
            <div className="mt-10 flex items-center sm:mt-14 lg:mt-16">
              ...
              <div className="mx-3 size-2 rounded-full border border-white/60 bg-white/20 shadow-[0_0_24px_rgba(255,255,255,0.45)] sm:mx-4"/>
      ...
      <div className=" pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#014F8E]/60 via-[#014F8E]/20 to-transparent" aria-hidden="true"/>
